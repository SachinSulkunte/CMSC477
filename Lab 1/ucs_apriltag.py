        ...
        try:
            ...
            for res in results:
                ...
                if res.tag_id == 32:
                    ...
                    ep_chassis.move(x=x_avg, y=y_dist, z=0, xy_speed=0.7).wait_for_completed()
                elif res.tag_id == 38:
                    ...
                    x_avg = (curr_x + x_dist) / 2.0
                    y_avg = (curr_y + y_dist) / 2.0
                    ep_chassis.move(x=x_avg, y=y_dist, z=180, xy_speed=0.7).wait_for_completed()
                elif res.tag_id == 39:
